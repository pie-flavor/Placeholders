...
@Plugin(id="placeholders",name="Placeholders",version="1.0.1",authors="pie_flavor")
    ...
    public void init(GameInitializationEvent e) {
        CommandSpec create = CommandSpec.builder()
                ...
                .arguments(flags()
                        ...
                        .valueFlag(requiringPermission(firstParsing(requiringPermission(location(Text.of("block")), "placeholders.extent.local.create.other.block"), requiringPermission(player(Text.of("player")), "placeholders.extent.local.create.other.player")), "placeholders.extent.local.create.other.use"), "-holder", "h")
                        .buildWith(seq(
                                string(Text.of("name")),
        ...
        CommandSpec remove = CommandSpec.builder()
                ...
                .arguments(flags()
                        ...
                        .valueFlag(requiringPermission(firstParsing(requiringPermission(location(Text.of("block")), "placeholders.extent.local.remove.other.block"), requiringPermission(player(Text.of("player")), "placeholders.extent.local.remove.other.player")), "placeholders.extent.local.remove.other.use"))
                        .buildWith(
                                string(Text.of("name"))
                        ))
                .build();
